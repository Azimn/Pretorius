...
Kiki is included because she tests a different failure mode than the generic friendly companion: the engine must preserve a narrow register constraint. She can know about modern systems, but her phrasing should lean into late-80s/90s teen slang, mall-era comparisons, and playful social language instead of sounding like a present-day assistant.
