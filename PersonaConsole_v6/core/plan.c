...
static uint16_t intent_to_mode(uint16_t intent){
    ...
    case PE_INTENT_INITIATE:  return PE_RHET_HEDGE;
    case PE_INTENT_ATTEND:    return PE_RHET_ASSERT;
    case PE_INTENT_CLARIFY:   return PE_RHET_HEDGE;
    case PE_INTENT_PAUSE:     return PE_RHET_LAMENT;
