...
static const BaselineTemplate UNIVERSAL_TEMPLATES[] = {
    ...
    { PE_BL_GROUP_ACK, PE_INTENT_ANSWER, 720, 0, 0,
      "I have the thread." },
    { PE_BL_GROUP_ACK, PE_INTENT_PROBE, 710, 0, 0,
      "Go on from there." },
    { PE_BL_GROUP_ACK, PE_INTENT_ANSWER, 700, 0, 0,
      "That lands clearly enough." },
    { PE_BL_GROUP_ACK, PE_INTENT_PROBE, 690, 0, 0,
      "Keep going. What follows?" },
