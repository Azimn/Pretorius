...
static void make_patterns(PatternTable *pt){
    ...
    struct {
        ...
        {"electricity",  T_SCIENCE,  +20, 45, +20, 3, G_WORKCHAT,  0},
        {"electric",     T_SCIENCE,  +18, 42, +18, 3, G_WORKCHAT,  0},
        {"electron",     T_SCIENCE,  +18, 42, +18, 3, G_WORKCHAT,  0},
        {"voltage",      T_SCIENCE,  +18, 42, +18, 3, G_WORKCHAT,  0},
        {"current",      T_SCIENCE,  +18, 42, +18, 3, G_WORKCHAT,  0},
        {"resistance",   T_SCIENCE,  +18, 42, +18, 3, G_WORKCHAT,  0},
        {"circuit",      T_SCIENCE,  +18, 42, +18, 3, G_WORKCHAT,  0},
        ...
        {"evening",      0xFFFF, +10, 20, +5, 0, G_GREETING,  0},
        {"i am back",    0xFFFF, +10, 20, +5, 0, G_GREETING,  0},
        {"i'm back",     0xFFFF, +10, 20, +5, 0, G_GREETING,  0},
        {"i have returned", 0xFFFF, +10, 20, +5, 0, G_GREETING, 0},
        {"good to see you", 0xFFFF, +15, 20, +8, 0, G_GREETING, 0},
        {"there you are", 0xFFFF, +10, 20, +5, 0, G_GREETING, 0},
        ...
        {"how are you holding up", 0xFFFF, +5, 20, 0, 3, G_STATUS, 0},
        {"how is your mood", 0xFFFF, +5, 20, 0, 3, G_STATUS,   0},
        {"how has the day treated you", 0xFFFF, +5, 20, 0, 3, G_STATUS, 0},
        {"are you all right", 0xFFFF, +5, 20, 0, 3, G_STATUS, 0},
        {"are you well",  0xFFFF, +5, 20, 0, 3, G_STATUS,     0},
        {"are you tired", 0xFFFF, +5, 20, 0, 3, G_STATUS,     0},
        {"are you in a good mood", 0xFFFF, +5, 20, 0, 3, G_STATUS, 0},
