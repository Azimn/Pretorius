...
int main(void){
    const char *DIR = "profiles/pretorius";
    rm_rf("profiles/pretorius/state.bin");
    rm_rf("profiles/pretorius/memory.bin");
    rm_rf("profiles/pretorius/chapters.bin");
    rm_rf("profiles/pretorius/relations");
    rm_rf("profiles/pretorius/aether");
