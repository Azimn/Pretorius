...
static void make_drives(DriveTable *dt){
    ...
    struct { const char *name; int16_t baseline; int16_t decay; int16_t weights[5]; } defs[] = {
      /*  O   C   E   A   N */
      {"Recognition",  650,  -8, { 200,   0, 800,-300, 200}},
      {"Stimulation",  700,  -6, { 900,-200, 600,   0, 200}},
      {"Provocation",  550,  -7, { 200,-400, 700,-600, 300}},
      {"Communion",    250,  -5, { 100, 100,-400, 800, 100}},
      {"Autonomy",     750, -10, { 700,-400, 200,-600, 300}},
      {"Continuity",   450,  -4, { 200, 600,   0, 200, 400}},
      {"Vindication",  500, -12, { 300,-200, 200,-700, 700}},
      {"Repose",       300,  -3, { 100, 400,-300, 200,-400}},
    };
...
static void make_patterns(PatternTable *pt){
    ...
    struct {
        const char *kw; uint16_t topic; int8_t v,a,d; int8_t cls; uint16_t group;
    } P[] = {
        /* praise */
        {"genius",       0xFFFF, +40, 40, +20, 1, G_PRAISE},
        {"brilliant",    0xFFFF, +35, 30, +20, 1, G_PRAISE},
        {"magnificent",  0xFFFF, +40, 30, +20, 1, G_PRAISE},
        {"wonderful",    0xFFFF, +30, 25, +10, 1, G_PRAISE},
        {"thank you",    0xFFFF, +15, 10,   0, 1, G_PRAISE},
        /* insult */
        {"fool",         0xFFFF, -40, 60, -20, 2, G_INSULT},
        {"madman",       0xFFFF, -20, 55, +10, 2, G_INSULT},
        {"monster",      0xFFFF, -30, 60, -10, 2, G_INSULT},
        {"obscene",      T_ETHICS,-50, 70, -10, 2, G_INSULT},
        {"hate",         0xFFFF, -60, 65, -30, 2, G_INSULT},
        {"sick",         0xFFFF, -30, 55,   0, 2, G_INSULT},
        /* threat */
        {"police",       0xFFFF, -30, 70, -30, 4, G_THREAT},
        {"arrest",       0xFFFF, -40, 75, -40, 4, G_THREAT},
        {"kill you",     0xFFFF, -80, 90, -50, 4, G_THREAT},
        {"stop you",     0xFFFF, -50, 70, -30, 4, G_THREAT},
        /* intimacy */
        {"love",         0xFFFF, +60, 50, +30, 5, G_INTIMACY},
        {"trust you",    0xFFFF, +50, 30, +20, 5, G_INTIMACY},
        {"my friend",    0xFFFF, +40, 25, +10, 5, G_INTIMACY},
        /* topical hooks */
        {"creation",     T_CREATION, +10, 60, +30, 0, G_CREATION},
        {"create",       T_CREATION, +10, 55, +30, 0, G_CREATION},
        {"life",         T_CREATION, +5,  40, +10, 0, G_CREATION},
        {"gin",          T_GIN,      +30, 20, +10, 0, G_GIN},
        {"drink",        T_GIN,      +20, 25, +10, 0, G_GIN},
        {"homunculi",    T_HOMUNCULI,+40, 60, +40, 0, G_HOMUNCULI},
        {"homunculus",   T_HOMUNCULI,+40, 60, +40, 0, G_HOMUNCULI},
        {"god",          T_GOD,      +20, 50, +30, 0, G_GOD},
        {"henry",        T_HENRY,    +5,  50, +10, 0, G_HENRY},
        {"frankenstein", T_HENRY,    +5,  55, +10, 0, G_HENRY},
        {"opera",        T_OPERA,    +30, 30, +10, 0, G_OPERA},
        {"music",        T_OPERA,    +20, 25, +10, 0, G_OPERA},
        {"death",        T_DEATH,    -10, 50,   0, 0, G_DEATH},
        {"dying",        T_DEATH,    -20, 50,   0, 0, G_DEATH},
        {"lightning",    T_LIGHTNING,+30, 70, +40, 0, 0xFFFF},
        {"bones",        T_BONES,    -10, 40,   0, 0, 0xFFFF},
        {"science",      T_SCIENCE,  +20, 40, +20, 0, 0xFFFF},
        {"work",         T_WORK,     +10, 40, +20, 0, 0xFFFF},
        {"ethics",       T_ETHICS,    -5, 35, +10, 0, 0xFFFF},
        {"beauty",       T_BEAUTY,   +30, 30, +10, 0, 0xFFFF},
        /* social */
        {"hello",        0xFFFF, +10, 20, +5, 0, G_GREETING},
        {"hi ",          0xFFFF, +10, 20, +5, 0, G_GREETING},
        {"good evening", 0xFFFF, +15, 20, +10, 0, G_GREETING},
        {"who are you",  0xFFFF, +5,  30, +10, 3, G_WHO},
        {"what is your name", 0xFFFF, +5, 30, +10, 3, G_WHO},
        {"why",          0xFFFF, 0,   30, 0, 3, G_QUESTION},
        {"how",          0xFFFF, 0,   30, 0, 3, G_QUESTION},
        {"what",         0xFFFF, 0,   30, 0, 3, G_QUESTION},
    };
