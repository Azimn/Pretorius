...
int main(void){
    ...
    (void)!system("rm -f characters/pretorius/state.bin "
                  "characters/pretorius/memory.bin "
                  "characters/pretorius/chapters.bin");
    (void)!system("rm -rf characters/pretorius/relations "
                  "characters/pretorius/aether");

    PersonaSession *s = ps_open("characters/pretorius/pretorius.cart");
    ...
    /* Hot-swap to Kiki. */
    int load_rc = ps_load(s, "characters/kiki/kiki.cart");
